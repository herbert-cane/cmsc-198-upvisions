...
public class CourseSubjectData
{
    ...
    public int units;
    public string lablec;
    public string prerequisites;
    public string semesterEligible;

    public CourseSubjectData(string courseCode, string courseTitle, int units, string lablec, string prerequisites, string semesterEligible)
    {
...
public class CourseSubjectDatabase
{
    ...
    void Start()
    {
        CommunicationAndMediaStudies = new Dictionary<string, List<CourseSubjectData>>()
        {
            ...
            { "First Year First Semester", new List<CourseSubjectData> {
                ...
                new CourseSubjectData("CMS_21", "Foundations of Media Writing", 3,"3LC-0LB", "", "1Y1S"),
                new CourseSubjectData("CMS_31", "Effective Oral Skills for Media Communication", 3,"3LC-0LB", "", "1Y1S"),
                new CourseSubjectData("CMS_100", "History of Media Communication", 3,"3LC-0LB", "", "1Y1S"),
                new CourseSubjectData("NSTP_1", "National Service Training Program 1", 0,"2LC-0LB", "", "1Y1S"),
                new CourseSubjectData("PE_1", "Foundations of Physical Fitness", 0,"2LC-0LB", "", "1Y1S")
            }},
            ...
            { "First Year Second Semester", new List<CourseSubjectData> {
                ...
                new CourseSubjectData("CMS_101", "Introduction to Media Communication", 3,"3LC-0LB", "", "1Y2S"),
                new CourseSubjectData("NSTP_2", "National Service Training Program 2", 0,"2LC-0LB", "", "1Y2S"),
                new CourseSubjectData("PE_2", "Foundations of Physical Fitness", 0,"2LC-0LB", "", "1Y2S")
            } },

            // **Second Year First Semester**
            { "Second Year First Semester", new List<CourseSubjectData> {
                new CourseSubjectData("CMS_E_3", "CMS Elective 3", 3,"3LC-0LB", "", "2Y1S"),
                new CourseSubjectData("CMS_E_4", "CMS Elective 4", 3,"3LC-0LB", "", "2Y1S"),
                new CourseSubjectData("GEC_5", "General Education Core 5", 3,"3LC-0LB", "", "2Y1S"),
                new CourseSubjectData("GEC_6", "General Education Core 6", 3,"3LC-0LB", "", "2Y1S"),
                new CourseSubjectData("GEC_7", "General Education Core 7", 3,"3LC-0LB", "", "2Y1S"),
                new CourseSubjectData("CMS_102", "Communication and Media Theories", 3,"3LC-0LB", "CMS_101", "2Y1S"),
                new CourseSubjectData("PE_3", "Foundations of Physical Fitness", 0,"2LC-0LB", "", "2Y1S")
            }},

            // **Second Year Second Semester**
            { "Second Year Second Semester", new List<CourseSubjectData> {
                new CourseSubjectData("CMS_E_5", "CMS Elective 3", 3,"3LC-0LB", "", "2Y1S"),
                ...
                new CourseSubjectData("CMS_103", "Media-Related Laws and Codes", 3,"3LC-0LB", "CMS_101", "2Y2S"),
                new CourseSubjectData("CMS_105", "Technologies in Media Communication", 3,"3LC-0LB", "CMS_100", "2Y2S"),
                new CourseSubjectData("PE_4", "Foundations of Physical Fitness", 0,"2LC-0LB", "", "2Y2S")
            }},

            // **Third Year First Semester**
            { "Third Year First Semester", new List<CourseSubjectData> {
                new CourseSubjectData("CMS_E_6", "CMS Elective 6", 3,"3LC-0LB", "", "3Y1S"),
                new CourseSubjectData("CMS_E_7", "CMS Elective 7", 3,"3LC-0LB", "", "3Y1S"),
                new CourseSubjectData("CMS_104", "Media and the Community", 3,"3LC-0LB", "CMS_102", "3Y1S"),
                new CourseSubjectData("CMS_107", "Fundamentals of Communication Planning", 3,"3LC-0LB", "CMS_102", "3Y1S"),
                new CourseSubjectData("CMS_190", "Digital Media Composition for Production", 3,"3LC-0LB", "", "3Y1S"),
            }},

            // **Third Year Second Semester**
            { "Third Year Second Semester", new List<CourseSubjectData> {
                new CourseSubjectData("FE_1", "Free Elective", 3,"3LC-0LB","", "3Y2S"),
                new CourseSubjectData("CMS_E_8", "CMS Elective 8", 3,"3LC-0LB", "", "3Y2S"),
                new CourseSubjectData("CMS_E_9", "CMS Elective 9", 3,"3LC-0LB", "","3Y2S"),
                new CourseSubjectData("CMS_110", "Development Media", 3,"3LC-0LB", "","3Y2S"),
                new CourseSubjectData("CMS_194", "Media Appreciation and Criticism", 3,"3LC-0LB", "CMS_102", "3Y2S"),
                new CourseSubjectData("CMS_197", "Communication Research Methods", 3,"3LC-0LB", "CMS_102, JuniorStanding", "3Y1S")
            }},

            // **Third Year Midyear**
            { "Third Year Midyear", new List<CourseSubjectData> {
                new CourseSubjectData("CMS 195", "Media Internship", 3,"3LC-0LB", "", "3YMid")
            }},

            // **Fourth Year First Semester**
            { "Fourth Year First Semester", new List<CourseSubjectData> {
                new CourseSubjectData("FE_2", "Free Elective", 3,"3LC-0LB", "", "4Y1S"),
                new CourseSubjectData("CMS_E_9", "CMS Elective 9", 3,"3LC-0LB", "", "4Y1S"),
                new CourseSubjectData("CMS_192", "Media Writing for Specific Purposes", 3,"3LC-0LB", "CMS_102", "4Y1S"),
                new CourseSubjectData("CMS_198", "Contemporary Issues in Media Communication", 3,"3LC-0LB", "CMS_195", "4Y1S"),
                new CourseSubjectData("CMS_199.1", "Research or Creative Work in Communication and Media Studies I", 3,"3LC-0LB", "CMS_197, SeniorStanding", "4Y1S"),
            }},

            // **Fourth Year Second Semester**
            { "Fourth Year Second Semester", new List<CourseSubjectData> {
                new CourseSubjectData("FE_3", "Free Elective", 3,"3LC-0LB", "", "4Y2S"),
                new CourseSubjectData("CMS_E_10", "CMS Elective 10", 3,"3LC-0LB", "", "4Y2S"),
                new CourseSubjectData("COMM_11", "Professional Communication", 3,"3LC-0LB", "", "4Y2S"),
                new CourseSubjectData("CMS_199.2", "Research or Creative Work in Communication and Media Studies II", 3,"3LC-0LB", "CMC_199.1, SeniorStanding", "4Y2S"),
                new CourseSubjectData("PI_100", "The Life and Works of Jose Rizal", 3,"3LC-0LB", "", "4Y2S")
            }},

            // CMS Electives
            { "CMS Electives", new List<CourseSubjectData> {
                new CourseSubjectData("CMS_11", "Professional Communication", 3,"3LC-0LB", "COMM_10", ""),
                new CourseSubjectData("CMS_12", "Technical Communication", 3,"3LC-0LB", "COMM_10", ""),
                new CourseSubjectData("CMS_21", "Dynamics of Human Communication", 3,"3LC-0LB", "None", ""),
                new CourseSubjectData("CMS_22", "Foundations of Media Writing", 3,"3LC-0LB", "None", ""),
                new CourseSubjectData("CMS_31", "Effective Oral Skills for Media Communication", 3,"3LC-0LB", "None", ""),
                new CourseSubjectData("CMS_100", "History of Media Communication", 3,"3LC-0LB", "None", ""),
                new CourseSubjectData("CMS_101", "Introduction to Media Communication", 3,"3LC-0LB", "None", ""),
                new CourseSubjectData("CMS_102", "Communication and Media Theories", 3,"3LC-0LB", "CMS_101", ""),
                new CourseSubjectData("CMS_103", "Media-Related Laws and Codes", 3,"3LC-0LB", "CMS_101", ""),
                new CourseSubjectData("CMS_104", "Media and the Community", 3,"3LC-0LB", "CMS_102", ""),
                new CourseSubjectData("CMS_105", "Technologies in Media Communication", 3,"3LC-0LB", "CMS_100", ""),
                new CourseSubjectData("CMS_107", "Fundamentals of Communication Planning", 3,"3LC-0LB", "CMS_102", ""),
                new CourseSubjectData("CMS_110", "Development Media", 3,"3LC-0LB", "CMS_100", ""),
                ...
                new CourseSubjectData("CMS_154", "Program Design in Broadcasting", 3,"3LC-0LB", "CMSC_111", ""),
                new CourseSubjectData("CMS_159", "Broadcast Programming and Management", 3,"3LC-0LB", "SeniorStanding", ""),
                new CourseSubjectData("CMS_160", "Understanding Advertising", 3,"3LC-0LB", "", "4Y2S"),
                ...
                new CourseSubjectData("CMS_163", "Media Planning and Evaluation", 3,"3LC-0LB", "CMS_160", ""),
                ...
                new CourseSubjectData("CMS_170", "Introduction to World Cinema", 3,"3LC-0LB", "", ""),
                new CourseSubjectData("CMS_171", "Introduction to Philippine Cinema", 3,"3LC-0LB", "", ""),
                new CourseSubjectData("CMS_172", "Approaches to Film Theory and Criticism", 3,"3LC-0LB", "", ""),
                new CourseSubjectData("CMS_173", "Gender Studies in Cinema", 3,"3LC-0LB", "", ""),
                ...
                new CourseSubjectData("CMS_190", "Digital Media Composition for Production", 3,"3LC-0LB", "", ""),
                new CourseSubjectData("CMS_192", "Media Writing for Specific Purposes", 3,"3LC-0LB", "CMS_102", ""),
                new CourseSubjectData("CMS_194", "Media Appreciation and Criticism", 3,"3LC-0LB", "CMS_102", ""),
                new CourseSubjectData("CMS_195", "Media Internship", 3,"200 hours", "JuniorStanding", ""),
                new CourseSubjectData("CMS_197", "Communication Research Methods", 3,"3LC-0LB", "CMS_102, JuniorStanding", ""),
                new CourseSubjectData("CMS_198", "Contemporary Issues in Media Communication", 3,"3LC-0LB", "CMS_195", ""),
            }}
